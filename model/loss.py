...
class FastSpeech2Loss(nn.Module):
    ...
    def forward(self, inputs, predictions, step):
        ...
        for mel_iter in mel_iters:
            ...
            mel_iter_loss += self.mae_loss(mel_iter, mel_targets)
        ...
        pitch_loss = energy_loss = torch.tensor([0.], device=mel_targets.device)

        # # KL Divergence Loss
        beta = torch.tensor([0.], device=mel_targets.device)
        kl_loss = torch.tensor([0.], device=mel_targets.device)
